        ...
        <React.Fragment>
            <div className="container">
                <div className="row">
                    ...
                    <div className="col">
                        <input type="text" name="taxe" value={props.item.taxe} onChange={evt => props.onItemChange(evt, props.item, "taxe")} />
                    </div>
                    <div className="col">
                        <input type="text" name="amount" value={props.item.amount} onChange={evt => props.onItemChange(evt, props.item, "amount")} />
                    </div>
                </div>
            </div>
        </React.Fragment>
